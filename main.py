...
INSTRUCTIONS:
    The project_report.pdf contains a subsection of the Instructions
    that provide a detailed understanding, with pictures of a
    successful working, of how to go about using the application.
